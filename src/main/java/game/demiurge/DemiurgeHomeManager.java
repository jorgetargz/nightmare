...
public class DemiurgeHomeManager {
    ...
    public int getLife() {
        return wizard.getLife();
    }

    public int getLifeMax() {
        return wizard.getLifeMax();
    }

    public boolean fullOfLife() {
        return wizard.getLife() == wizard.getLifeMax();
    }


    public int getSinga() {
        return home.getSinga();
    }

    public int getSingaSpace() {
        return home.getSingaSpace();
    }

    public Container getCarrier() {
        return wizard.getCrystalCarrier();
    }
    ...
    public Knowledge getMemory() {
        return wizard.getMemory();
    }
    ...
    public Knowledge getLibrary() {
        return home.getLibrary();
    }
